...
interface ManagerLoginFormInputs {
...
export default function ManagerLoginContent() {
    ...
    const { handleSubmit, control, formState: { errors } } = useForm<ManagerLoginFormInputs>({
        defaultValues: {
    ...
    const onSubmit = async (data: ManagerLoginFormInputs) => {
